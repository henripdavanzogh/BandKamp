...
# postgresql://pass@host:port/database
if DATABASE_URL:
...
SPECTACULAR_SETTINGS = {
    "TITLE": "BandKamp",
    "DESCRIPTION": "Projeto responsável por criação de músicas e álbuns, incluindo relacionamentos entre as tabelas de 'users', 'albums' e 'songs'.",
    "VERSION": "1.0.0",
